...
import { Alert, AlertColor, Autocomplete, Button, Card, CardActionArea, CardActions, CardContent, CardHeader, CardMedia, Collapse, IconButton, IconButtonProps, Skeleton, styled, TextField, Typography } from "@mui/material";
...
export default function ChildrensDraw() {
  /*
  ...
  */
  ...
  return (
    <main className="min-h-screen flex flex-col">
      <Navbar />
      <Typography variant="h3" className="text-center h-12">Childrens Draw</Typography>
