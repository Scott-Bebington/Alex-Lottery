...
export default function KidsDraw(
    ...
    */
    ...
    const selectTicket = (ticketNumber: number) => {
        setSelectedTicket(kidsTickets.find(ticket => ticket.number === ticketNumber) || null);
    }
    ...
    */
    ...
    const addTicketsToCart = async () => {
        ...
        if (auth.currentUser === null) {
            ...
            urlParams.append("execute", "addkidsTickets");
    ...
    useEffect(() => {
        if (initialRender.current === false) {
            ...
            if (urlParams.size > 0 && kidsTickets.length > 0) {
                const execute = urlParams.get('execute');

                if (execute !== "addkidsTickets") {
                    return;
                }
    ...
    */
    useEffect(() => {
        const filtered = kidsTickets.filter(ticket =>
